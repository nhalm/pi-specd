...
/**
 * Watch terminal input for Ctrl+C (or Escape) and abort whichever
 * AbortController is currently active. Loop drives this pattern so each
 * phase gets a fresh controller and Ctrl+C only aborts the in-flight
 * sub-agent, not the entire loop.
 *
